...
using PagedList;
namespace _23DH113462_MyStore.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Admin/Products
        public ActionResult Index(string searchTerm, decimal? minPrice, decimal? maxPrice, string sortOrdeг, int? page)
        {
